...
import{changeImg,openInfo, closeInfo, plusProduct, minusProduct} from "./modules/navigation-click-card.js"
...
if(window.location.href === 'http://localhost:8081/card.html'){
document.querySelector('.photo-container').addEventListener('click',  changeImg)
document.querySelector('.open-text').addEventListener('click', openInfo)

document.querySelector('.close-text').addEventListener('click', closeInfo)
document.addEventListener('click', plusProduct)
document.addEventListener('click', minusProduct)
