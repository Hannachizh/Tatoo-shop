...
//import {getRenderLimit} from "./modules/server.js"
import {toCatalog} from "./modules/navigation-click1.js"
import {getrenderLimits} from "./modules/navigation-click1.js"
import {hitPart, popular, newFirstPage, discont, validInputMail, validInputName, solvePrivateInfo, sendConfirmForm, catalogAllHits} from "./modules/navigation-click1.js"
...
//getLocalTrash()
 ...
 //*******navig-click1 ***********
 if(window.location.href === 'http://localhost:8081/index.html'){
document.querySelector('.head-catalog-moover').addEventListener('click', toCatalog)

document.querySelector('.open-catalog-btn').addEventListener('click', toCatalog)
getrenderLimits('new')

document.querySelector('.hits').addEventListener('click', hitPart)
document.querySelector('.popular').addEventListener('click', popular)
document.querySelector('.new').addEventListener('click', newFirstPage)
document.querySelector('.discont').addEventListener('click', discont)

//form
document.forms.confirmForm.elements.eMail.onblur = () => { validInputMail(false) }
document.forms.confirmForm.elements.userName.onblur = () => { validInputName(false) }
document.getElementById('check').onblur = function () { solvePrivateInfo(false); }
document.querySelector('#btn').addEventListener('click',sendConfirmForm)

document.querySelector('.allHits').addEventListener('click', catalogAllHits)
